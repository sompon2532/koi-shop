                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="app-navbar-collapse">
                        <ul class="nav navbar-nav navbar-center">
                            ...
                            @else
                                <li><a class="{{ Request::segment(1) == 'koi'  ? 'text-red' : '' }}" href="{{ url('/') }}">{{ trans('header.koi') }}</a></li>                                
                            @endif 
                            ...
                            @else
                                <li><a class="{{ Request::segment(1) == 'product'  ? 'text-red' : '' }}" href="{{ url('/') }}">{{ trans('header.koi-products') }}</a></li>                                
                            @endif 

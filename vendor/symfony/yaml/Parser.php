...
class Parser
{
        ...
        do {
            ...
            if (self::preg_match('#^\-((?P<leadspaces>\s+)(?P<value>.+))?$#u', rtrim($this->currentLine), $values)) {
                if ($context && 'mapping' == $context) {
                    throw new ParseException('You cannot define a sequence product when in a mapping', $this->getRealCurrentLineNb() + 1, $this->currentLine);
                }
                $context = 'sequence';
                ...
                if ($context && 'sequence' == $context) {
                    throw new ParseException('You cannot define a mapping product when in a sequence', $this->currentLineNb + 1, $this->currentLine);
                }
                $context = 'mapping';
    ...
    private function getNextEmbedBlock($indentation = null, $inSequence = false)
    {
        ...
        if ($inSequence && $oldLineIndentation === $newIndent && isset($data[0][0]) && '-' === $data[0][0]) {
            // the previous line contained a dash but no product content, this line is a sequence product with the same indentation
    ...
    /**
     * Returns true if the string is un-indented collection product.
     *
     * @return bool Returns true if the string is un-indented collection product, false otherwise
     */
